...
do
  ...
  VAR_REVERSE_PROXY_DISABLE_RESOLVER="$1REVERSE_PROXY_DISABLE_RESOLVER$i"
  VAR_REVERSE_PROXY_WEBSOCKET="$1REVERSE_PROXY_WEBSOCKET$i"
  ...
  NGINX_PROXY_DISABLE_RESOLVER=${!VAR_REVERSE_PROXY_DISABLE_RESOLVER}
  NGINX_PROXY_WEBSOCKET=${!VAR_REVERSE_PROXY_WEBSOCKET}
...
_EOF_
    ...
    if [ "${NGINX_PROXY_WEBSOCKET}" = 'true' ]; then
      REVERSE_PROXY_UPGRADE='$http_upgrade'
