...
for (( i = 1; ; i++ ))
do
  VAR_REVERSE_PROXY_LOCATION="REVERSE_PROXY_LOCATION$i"
  VAR_REVERSE_PROXY_PASS="REVERSE_PROXY_PASS$i"
  VAR_REVERSE_PROXY_BUFFERING="REVERSE_PROXY_BUFFERING$i"
  VAR_REVERSE_PROXY_BUFFERS="REVERSE_PROXY_BUFFERS$i"
  VAR_REVERSE_PROXY_BUFFERS_SIZE="REVERSE_PROXY_BUFFERS_SIZE$i"
